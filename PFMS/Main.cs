                ...
                switch (urlParts[2].ToLower())
                {
                    case "estop":
                        switch (urlParts[3].ToLower())
                        {
                            ...
                            case "match":
                                estop = true;
                                string responseEstopMatch = "<html><head><title>Match Estop</title></head><body><h1>The Match has been EStopped.</h1></body></html>";
                                byte[] bufferEstopMatch = System.Text.Encoding.UTF8.GetBytes(responseEstopMatch);
                                context.Response.ContentLength64 = bufferEstopMatch.LongLength;
                                context.Response.OutputStream.Write(bufferEstopMatch, 0, bufferEstopMatch.Length);
                                context.Response.OutputStream.Close();
                                context.Response.Close();
                                break;
                    ...
                    case "json":
                        ...
                        context.Response.ContentLength64 = bufferJSON.LongLength;
                        context.Response.OutputStream.Write(bufferJSON, 0, bufferJSON.Length);
                        context.Response.OutputStream.Close();
                        context.Response.Close();
                        break;

                    default:
                        string response = "<html><head><title>Main - PracticeFMS Web Interface</title><link id=\"favicon\" rel=\"shortcut icon\" type=\"image/png\" href=\"data:image/png;base64,\"><style>table, td, tr {border: 1px solid black; } td, tr { padding: 10px; } h1, h2 { text-align: center; text-align: -webkit-center; margin: auto}	.left {float: left; width: 45%; text-align: center; text-align: -webkit-center; } .right {float: right; width: 45%; text-align: center; text-align: -webkit-center; } .redAlliance {background-color: #ff4450} .blueAlliance {background-color: #4450ff} .red {background-color: #ff003a6b}	.green {background-color: #4caf5063} @media screen and (max-width: 950px) {	.left, .main, .right {  width: 100%; margin-bottom: 50px; } } </style></head><body onload=\"setTimeout(1500, location.reload(true));\"><h1 style=\"font-size: 3vw; max-width: 75%;\">Welcome to the PracticeFMS Web Interface</h1><br/><h2 style=\"font-size: 2.5vw; max-width: 50%;\">Current Field Status</h2><br/><div style=\"text-align: -webkit-center\"><table><tr><td>Current Match Phase:</td><td>" + currentGamePhase.ToString() +"</td></tr><tr><td>Time left in phase:</td><td>" + TimeLeftInPhase + " seconds</td></td></tr><tr><td colspan=\"2\"><a href=\"estop/match\">EStop the match.</a></td></tr></table></div><br/><h2 style=\"font-size: 2.5vw; max-width: 50%;\">Current Robot Status:</h2><br/><div><div class=\"left\">";
                        foreach (DriverStation ds in redAlliance)
                        {
                            if (ds != null)
